...
Below we estimate `pi`, `ho`, `he`, F~IS~, HWE and pairwise F~ST~. We estimate
...
Lastly we have our F~ST~ measures and Nei's genetic distance measures as heatmaps.
...
First we'll save the combined matricies to file, where upper triangle is F~ST~
and the lower triangle is Nei's genetic distnace.
